...
Feature: my_feature
  my_feature is part of a set of themes/epics/features with non-unique names, so only one of the set is reported by Serenity BDD (this is expected behavior).
  ...
  * themeWithCamelCase/epicWithCamelCase/featureWithCamelCase.feature
  ...
  Scenario: My feature with underscore Test scenario
    Given a number '1'
    And a number '1'
    When added together
