...
Feature: feature_with_underscore
    feature_with_underscore is part of the set of following themes/epics/features that have been included in the test suite, showing the space, underscore, dash and camelCase naming convention are all valid as long as the names are unique.
  ...
  Scenario: "feature_with_underscore" Test scenario
    Given a number '1'
    And a number '1'
    When added together
